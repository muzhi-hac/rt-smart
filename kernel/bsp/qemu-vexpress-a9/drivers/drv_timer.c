...
static void system_conter_clk_source_init(void)
{
    /* enable system counter */
    // SYS_CTRL |= REALVIEW_SYSCTRL_ENABLE;
}
static void system_conter_clk_source_init(void)
{
    /* enable system counter */
...
static void processor_clock_source_init(void)
{
    /*set time out vlaue and start timer and enable interrupt*/
    /* enable processor clock */
    SYS_CTRL |= REALVIEW_PROCCLK;
}
